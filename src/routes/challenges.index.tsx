...
import { Trophy, Users, Calendar, Check, ArrowUpRight } from "lucide-react";
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                ...
                {isJoined && c.community ? (
                  <Link
                    to="/challenges/$id"
                    params={{ id: c.id }}
                    className="mt-6 inline-flex h-11 w-full items-center justify-center gap-2 bg-secondary text-sm font-medium text-secondary-foreground transition-colors hover:bg-secondary/80"
                  >
                    View Challenge <ArrowUpRight className="h-4 w-4" />
                  </Link>
                ) : (
                  <button
                    onClick={async () => {
